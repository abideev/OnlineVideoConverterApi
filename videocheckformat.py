...
def YoutubeParce(url):
  videoformat = { '394': {'resolution': '256x144', 'format': '144p', 'extension': 'mp4', 'fps': '30'},
  ...
  for format in formats:
    for video_tag, data in videoformat.items():
...
#YoutubeParce("https://www.youtube.com/watch?v=N5aReki7icg&ab_channel=VWestlife", videoformat)
